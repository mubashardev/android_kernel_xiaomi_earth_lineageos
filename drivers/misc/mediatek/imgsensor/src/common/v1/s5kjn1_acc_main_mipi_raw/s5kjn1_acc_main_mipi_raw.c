...
#include "s5kjn1_acc_main_mipi_raw.h"
...
#define PFX "S5KJN1_ACC_camera_sensor"

#define LOG_INF(format, args...)    pr_err(PFX "[%s] " format, __func__, ##args)

static DEFINE_SPINLOCK(imgsensor_drv_lock);
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KJN1_ACC_MAIN_SENSOR_ID ,
...
static void sensor_init(void)
{
	...
	mdelay(10);
		...
		addr_data_pair_init_s5kjn1acc,
		sizeof(addr_data_pair_init_s5kjn1acc) / sizeof(kal_uint16));
}
...
static void normal_video_setting(kal_uint16 currefps)  // 30fps
{
	...
	s5kjn1_multi_write_cmos_sensor(
		...
		sizeof(addr_data_pair_normal_video_s5kjn1acc) / sizeof(kal_uint16));
}
...
static void slim_video_setting(void) //60fps
{
	...
	s5kjn1_multi_write_cmos_sensor(
		...
		sizeof(addr_data_pair_slim_video_s5kjn1acc) / sizeof(kal_uint16));
}
		...
		/*	if (vendor_id == 0x10) {
				*sensor_id = return_sensor_id();
				...
				if (*sensor_id == imgsensor_info.sensor_id) {
					pr_info("s5kjn1acc_ofilm i2c 0x%x, sid 0x%x\n",
...
static kal_uint32 set_test_pattern_mode(kal_bool enable)
{
	...
	if (enable) {
		...
		s5kjn1_multi_write_cmos_sensor(
			...
			sizeof(addr_data_pair_set_test_pattern_s5kjn1acc) / sizeof(kal_uint16));
	} else {
...
UINT32 S5KJN1_ACC_MAIN_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	LOG_INF("S5KJN1_ACC_MAIN_MIPI_RAW_SensorInit in  fufu\n");
