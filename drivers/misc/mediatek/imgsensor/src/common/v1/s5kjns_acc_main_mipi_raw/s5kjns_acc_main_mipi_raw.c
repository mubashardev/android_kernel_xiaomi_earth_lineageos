...
#include "s5kjns_acc_main_mipi_raw.h"
...
#define PFX "S5KJNS_ACC_camera_sensor"
...
/* code at 2022/9/6 start */
	.sensor_id = S5KJNS_ACC_MAIN_SENSOR_ID ,
...
/* code at 2022/9/6 start */
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_s5kjnsacc[] = {
    /*
	0x6028,0x2400,
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x0000, 0x38ee);//38e1);
	write_cmos_sensor(0x001e, 0x000b);//0007);
	write_cmos_sensor(0x6028, 0x4000);
	...
	//mdelay(10);
		...
		addr_data_pair_init_s5kjnsacc,
		sizeof(addr_data_pair_init_s5kjnsacc) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_s5kjnsacc[] = {
	0x0100,0x0000,
	0x6028,0x2400,
	0x602A,0x1A28,
	0x6F12,0x4C00,
...
static void preview_setting(void)
{
	...
	s5kjns_multi_write_cmos_sensor(
		addr_data_pair_preview_s5kjnsacc,
		sizeof(addr_data_pair_preview_s5kjnsacc) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_s5kjnsacc[] = {
	0x0100,0x0000,
	0x6028,0x2400,
	0x602A,0x1A28,
	0x6F12,0x4C00,
...
static void hs_video_setting(void) /// 120fps
{
	...
	s5kjns_multi_write_cmos_sensor(
		addr_data_pair_hs_video_s5kjnsacc,
		sizeof(addr_data_pair_hs_video_s5kjnsacc) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_s5kjnsacc[] = {
	0x0100,0x0000,
	0x6028,0x2400,
	0x602A,0x1A28,
	0x6F12,0x4C00,
...
static void capture_setting(kal_uint16 currefps)
{
	LOG_INF("start\n");
        s5kjns_multi_write_cmos_sensor(
		addr_data_pair_capture_s5kjnsacc,
		sizeof(addr_data_pair_capture_s5kjnsacc) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_normal_video_s5kjnsacc[] = {
	0x0100,0x0000,
	0x6028,0x2400,
	0x602A,0x1A28,
	0x6F12,0x4C00,
...
static void normal_video_setting(kal_uint16 currefps)  // 30fps
{
	...
	s5kjns_multi_write_cmos_sensor(
		addr_data_pair_normal_video_s5kjnsacc,
		sizeof(addr_data_pair_normal_video_s5kjnsacc) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_s5kjnsacc[] = {
	0x0100,0x0000,
	0x6028,0x2400,
	0x602A,0x1A28,
	0x6F12,0x4C00,
...
static void slim_video_setting(void) //60fps
{
	LOG_INF("E\n");
	s5kjns_multi_write_cmos_sensor(
		addr_data_pair_slim_video_s5kjnsacc,
		sizeof(addr_data_pair_slim_video_s5kjnsacc) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_custom1_s5kjnsacc[] = {
	0x0100,0x0000,
	0x6028,0x2400,
	0x602A,0x1A28,
	0x6F12,0x4C00,
...
static void custom1_setting(void)
{
	LOG_INF("E\n");
	s5kjns_multi_write_cmos_sensor(
		addr_data_pair_custom1_s5kjnsacc,
		sizeof(addr_data_pair_custom1_s5kjnsacc) / sizeof(kal_uint16));
}
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_set_test_pattern_s5kjnsacc[] = {
	0x0200,0x0002,
	0x0202,0x0002,
	0x0204,0x0020,
	0x020E,0x0100,
...
UINT32 S5KJNS_ACC_MAIN_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	LOG_INF("S5KJNS_ACC_MAIN_MIPI_RAW_SensorInit in  fufu\n");
