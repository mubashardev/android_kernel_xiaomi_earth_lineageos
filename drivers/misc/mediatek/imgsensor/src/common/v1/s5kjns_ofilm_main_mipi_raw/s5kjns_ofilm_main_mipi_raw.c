...
#include "s5kjns_ofilm_main_mipi_raw.h"
/* code at 2022/9/6 start */
#include "../gc6133c_hlt_i_i2c4/gc6133c_hlt_i_i2c4.h"
...
#define PFX "S5KJNS_OFILM_camera_sensor"

#define LOG_INF(format, args...)    pr_err(PFX "[%s] " format, __func__, ##args)

static DEFINE_SPINLOCK(imgsensor_drv_lock);
static struct imgsensor_info_struct imgsensor_info = {
/* code at 2022/9/8 start */
/* code at 2022/11/28 start */
	.sensor_id = S5KJNS_OFILM_MAIN_SENSOR_ID ,
	.checksum_value = 0xdb9c643,
	.pre = {
		.pclk = 560000000,
		.linelength = 4584,//5894,
		.framelength = 4054,//3168,
		.startx = 0,
		.starty = 0,
...
/* code at 2022/11/28 end */
	.normal_video = {
		.pclk = 560000000,
		.linelength = 5910,
		.framelength = 3152,//3156,
		.startx = 0,
		.starty = 0,
		.grabwindow_width = 4080,
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_s5kjnsofilm[] = {
	0x6028,0x2400,
	/*
	0x602A,0x7700,
	0x6F12,0x1753,
...
static void sensor_init(void)
{
	...
	mdelay(10);
		...
		addr_data_pair_init_s5kjnsofilm,
		sizeof(addr_data_pair_init_s5kjnsofilm) / sizeof(kal_uint16));
}

/* code at 2022/9/13 start */
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_s5kjnsofilm[] = {
	0x6028,0x2400,
	0x602A,0x1A28,
	0x6F12,0x4C00,
	0x602A,0x065A,
...
static void preview_setting(void)
{
	...
	s5kjns_multi_write_cmos_sensor(
		addr_data_pair_preview_s5kjnsofilm,
		sizeof(addr_data_pair_preview_s5kjnsofilm) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_s5kjnsofilm[] = {
	0x6028,0x2400,
	0x602A,0x1A28,
	0x6F12,0x4C00,
	0x602A,0x065A,
...
static void hs_video_setting(void) /// 120fps
{
	...
	s5kjns_multi_write_cmos_sensor(
		addr_data_pair_hs_video_s5kjnsofilm,
		sizeof(addr_data_pair_hs_video_s5kjnsofilm) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_s5kjnsofilm[] = {
	0x6028,0x2400,
	0x602A,0x1A28,
	0x6F12,0x4C00,
	0x602A,0x065A,
...
static void capture_setting(kal_uint16 currefps)
{
	LOG_INF("start\n");
        s5kjns_multi_write_cmos_sensor(
		addr_data_pair_capture_s5kjnsofilm,
		sizeof(addr_data_pair_capture_s5kjnsofilm) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_normal_video_s5kjnsofilm[] = {
	0x6028,0x2400,
	0x602A,0x1A28,
	0x6F12,0x4C00,
	0x602A,0x065A,
...
static void normal_video_setting(kal_uint16 currefps)  // 30fps
{
	...
	s5kjns_multi_write_cmos_sensor(
		addr_data_pair_normal_video_s5kjnsofilm,
		sizeof(addr_data_pair_normal_video_s5kjnsofilm) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_s5kjnsofilm[] = {
	0x6028,0x2400,
	0x602A,0x1A28,
	0x6F12,0x4C00,
	0x602A,0x065A,
...
static void slim_video_setting(void) //60fps
{
	LOG_INF("E\n");
	s5kjns_multi_write_cmos_sensor(
		addr_data_pair_slim_video_s5kjnsofilm,
		sizeof(addr_data_pair_slim_video_s5kjnsofilm) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_custom1_s5kjnsofilm[] = {
	0x6028,0x2400,    
	0x602A,0x1A28,    
	0x6F12,0x4C00,    
	0x602A,0x065A,    
...
#endif
/* code at 2022/9/13 end */

static void custom1_setting(void)
{
	LOG_INF("E\n");
	s5kjns_multi_write_cmos_sensor(
		addr_data_pair_custom1_s5kjnsofilm,
		sizeof(addr_data_pair_custom1_s5kjnsofilm) / sizeof(kal_uint16));
}
			...
			if (vendor_id == 0x07) {
				*sensor_id = return_sensor_id();
				...
				if (*sensor_id == imgsensor_info.sensor_id) {
					pr_info("s5kjns_ofilm i2c 0x%x, sid 0x%x\n",
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_set_test_pattern_s5kjnsofilm[] = {
	0x0200,0x0002,
	0x0202,0x0002,
	0x0204,0x0020,
	0x020E,0x0100,
...
static kal_uint32 set_test_pattern_mode(kal_bool enable)
{
	...
	if (enable) {
		...
		// s5kjns_multi_write_cmos_sensor(
		// addr_data_pair_set_test_pattern_s5kjnsacc,
		// sizeof(addr_data_pair_set_test_pattern_s5kjnsacc) / sizeof(kal_uint16));
		...
		write_cmos_sensor(0x0602, 0x0200);
		write_cmos_sensor(0x0604, 0x0200);
		write_cmos_sensor(0x0606, 0x0200);
		write_cmos_sensor(0x0608, 0x0200);
		/* code at 2022/10/27 start */
		write_cmos_sensor(0x0600, 0x0000);
		/* code at 2022/10/27 end */
...
UINT32 S5KJNS_OFILM_MAIN_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	LOG_INF("S5KJNS_OFILM_MAIN_MIPI_RAW_SensorInit in  xiaofu\n");
