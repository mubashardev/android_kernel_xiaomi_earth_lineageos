...
#include "s5kjns_sunny_main_mipi_raw.h"
...
/* code at 2022/9/8 start */
	.sensor_id = S5KJNS_SUNNY_MAIN_SENSOR_ID ,
...
UINT32 S5KJNS_SUNNY_MAIN_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	LOG_INF("S5KJNS_SUNNY_MAIN_MIPI_RAW_SensorInit in  xiaofu\n");
